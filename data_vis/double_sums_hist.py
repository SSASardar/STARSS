...
def plot_dual_sums_histogram(file_path, save_path=None, bins=30):
    ...
    ax.hist(sums1, bins=n_bins, alpha=0.6, color='steelblue', 
            edgecolor='black', linewidth=0.5, label='Strategy 1 (Column 8)', 
            density=True)
    ax.hist(sums2, bins=n_bins, alpha=0.6, color='salmon', 
...
# Save the figure
#plot_dual_sums_histogram(
#    "batch_test_20260825_100749/sums_results.txt",
#    save_path="dual_sums_histogram.png"
#)
